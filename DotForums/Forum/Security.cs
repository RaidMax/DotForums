...
namespace DotForums.Forum
{
    public class Security
    {
        ...
        /// <summary>
        /// Generate A concatenated salt + hashed password + iteration count
        /// </summary>
        /// <param name="password">plain-text password of user</param>
        /// <param name="count">how many times to iterate through the hashing algorithm</param>
        /// <returns>a base64 encoded string containing the generated salt + hashed password + the iteration amount</returns>
        ...
        /// <summary>
        /// Determines whether a given string matches the password in a hash string
        /// </summary>
        /// <param name="input">plaint-text password to test with</param>
        /// <param name="passwordHash">(stored) concatenated string generated by GeneratePassword()</param>
        /// <returns>True if generated hash matches the password hash, false otherwise</returns>
